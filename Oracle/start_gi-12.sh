...
export OHGRID=/u01/app/oracle/product/anthem/grid.12.2.0.1.220118
...
# CheckSum
export SRCCHKSUM=$SCRIPTS/gihome_12.sum
export DSTCHKSUM=$LOGDIR/gihome_12.sum
# OPatch
...
MAIN_LST=33587128,33678030,33116894,26839277,33610989
